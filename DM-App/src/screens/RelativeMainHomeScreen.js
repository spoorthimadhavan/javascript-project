...
export default RelativeMainHomeScreen = ({
  navigation,
  ...
  //get/filter patient
  const sendPatientHandler = () => {
    dispatch(actions.storeUserDetails(patient));
    navigation.navigate("relativedashhomes");
  };
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.body}>
          <Text style={styles.greeting}>
            Hello, {userData != null ? userData.username : ""} Relative
          </Text>
          ...
          <View style={{ width: width / 1.1 }}>
            ...
            {Object.keys(patient).length === 0 ? (
              ...
              <View style={styles.patientRecord} key={patient?.uuid}>
                <TouchableOpacity onPress={sendPatientHandler}>
                  <View
                    style={{
                      flexDirection: "row",
